...
public class NormalEvent extends Event {
    ...
    public NormalEvent(String name, String location, String startTime, String endTime, Boolean repeat, int frequency){
    ...
    public String prepForSave(){
           return "1/"+name+"/"+location+"/"+startTime+"/"+endTime+"/"+repeat+"/"+frequency+"/";
    }
